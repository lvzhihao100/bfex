...
import static com.sskj.bfex.v.widget.mychart.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.sskj.bfex.v.widget.mychart.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.sskj.bfex.v.widget.mychart.BubbleSeekBar.TextPosition.SIDES;
import static com.sskj.bfex.v.widget.mychart.BubbleUtils.dp2px;
import static com.sskj.bfex.v.widget.mychart.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    private int mTrackSize; // height of right-selector_track(on the right of thumb)
    private int mSecondTrackSize; // height of left-selector_track(on the left of thumb)
    private int mThumbRadius; // radius of thumb
    private int mThumbRadiusOnDragging; // radius of thumb when be dragging
    private int mTrackColor; // color of right-selector_track
    private int mSecondTrackColor; // color of left-selector_track
    ...
    @TextPosition
    private int mSectionTextPosition = NONE; // text position of section-text relative to selector_track
    ...
    private boolean isTouchToSeek; // touch anywhere on selector_track to quickly seek
    ...
    private float mTrackLength; // pixel length of whole selector_track
    private float mSectionOffset; // pixel length of one section
    private boolean isThumbOnDragging; // is thumb on dragging or not
    private int mTextSpace; // space between text and selector_track
    ...
    private float mLeft; // space between left of selector_track and left of the view
    private float mRight; // space between right of selector_track and left of the view
    ...
    private void locatePositionOnScreen() {
        ...
        if (BubbleUtils.isMIUI()) {
            mBubbleCenterRawSolidY += dp2px(2);
        }
    ...
    /**
     * Detect effective touch of selector_track
     */
    ...
    private float formatFloat(float value) {
        ...
        return bigDecimal.setScale(floatScale, BigDecimal.ROUND_HALF_UP).floatValue();
    }

    public void setFloatScale(int scale) {
    ...
    /**
     * Customize the section texts under the selector_track according to your demands by
