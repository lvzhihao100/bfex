...
/**
 * SharedPreferences封装类SPUtils  * @Project  App_ZXing  * @Package  com.android.scan  * @author   chenlin  * @version  1.0  * @Date    2013年6月6日  * @Note    TODO
 */
public class SPUtils {
    ...
    public static Object getBean(Context context, String key) {
        Object obj = null;
        try {
            String base64 = context.getApplicationContext().getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE).getString(key, "");
