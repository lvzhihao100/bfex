...
public class CombinedChartRenderer extends DataRenderer {
    ...
    public CombinedChartRenderer(CombinedChart chart, ChartAnimator animator, ViewPortHandler viewPortHandler, int widthPixels) {
            ...
            switch (order) {
                ...
                case CANDLE:
                    if (chart.getCandleData() != null) {
                        mRenderers.add(new MyCandleStickChartRenderer(chart, mAnimator, mViewPortHandler, screenWidth));
                    }
                    break;
                case SCATTER:
